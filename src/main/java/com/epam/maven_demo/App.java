...
class gift{
	...
	gift(String name,double price,String to,double weight)
	{
		this.name=name;
		this.price=price;
		this.to=to;
...
class choco extends gift{
	String brand;
	choco(String name,double price,double weight,String to,String brand)
	{
		super(name,price,to,weight);
		this.brand=brand;
	}
...
class can extends gift{
	
	String col;
	can(String name,double price,double weight,String to,String col)
	{
		super(name,price,to,weight);
		this.col=col;
	}
...
class sweet extends gift{
	String type;
	sweet(String name,double price,double weight,String to,String type)
	{
		super(name,price,to,weight);
		this.type=type;
	}
   		...
   		case 1:
   			System.out.println( "Enter no of chocolate you want to add: " );
		        ...
		        for(int i=0;i<n;i++)
		        {
		        	...
		        	brand=sc.nextLine();
		        	C.add(new choco(name,price,weight,to,brand));
		        }
		     System.out.println( "\nObject created" );
		     for(choco co: C)
		    	 {
		     ...
		     {
		    	 System.out.println( "\nSort by price" );
		    	 Collections.sort(C,new chococomparebyprice());
		     }
		     else if(c2==2)
		     {
		    	 System.out.println( "\nSort by weight" );
   		...
   		case 2:
	        ...
	        for(can co: cd)
		     ...
		     if(c2==1)
		     {
		    	 ...
		    	 for(can co:cd)
		    	 {
		    		 if(min <=co.getprice() && max >= co.getprice())
		    		 {
		    			 co.dis();
		    		 }
		    	 }
